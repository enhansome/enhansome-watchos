...
* [YOChartImageKit](https://github.com/yasuoza/YOChartImageKit) ⭐ 424 | 🐛 9 | 🌐 Objective-C | 📅 2019-12-12 - A chart image framework for watchOS.
...
* [SwiftHN](https://github.com/Dimillian/SwiftHN) ⭐ 1,741 | 🐛 21 | 🌐 Swift | 📅 2020-10-01 - A Hacker News reader written in Swift.
...
* [WWDC](https://github.com/sugarso/WWDC) ⭐ 384 | 🐛 1 | 🌐 Swift | 📅 2019-06-04 - An open sourcing WWDC hit parties app.
...
* [WatchPics](https://github.com/D-32/WatchPics) ⭐ 95 | 🐛 4 | 🌐 Objective-C | 📅 2021-01-24 - Instagram for the Apple Watch.
...
* [Lister](https://developer.apple.com/library/ios/samplecode/Lister/Introduction/Intro.html) - An official sample app demonstrates Apple Watch integration.
  ...
  <space><space>\<img src="<https://github.com/yenchenlin1994/awesome-watchos/blob/master/resources/lister.png> ⭐ 501 | 🐛 4 | 🌐 Ruby | 📅 2018-07-05") alt="Example App" width="260"/>
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 51,660 | 🐛 3 | 📅 2026-08-13 list of open source ios apps
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,608 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02 list.
* [awesome-ios-ui](https://github.com/cjwirth/awesome-ios-ui) ⭐ 11,214 | 🐛 12 | 📅 2018-03-08 - A curated list of awesome iOS UI/UX libraries.
* [awesome-ios-animation](https://github.com/sxyx2008/awesome-ios-animation) ⭐ 5,454 | 🐛 0 | 📅 2025-10-28 - A curated list of awesome iOS animation, including Objective-C and Swift libraries.
...
* [awesome-gists](https://github.com/vsouza/awesome-gists#ios) ⭐ 768 | 🐛 1 | 📅 2025-06-24 - A list of amazing gists (iOS section).
...
* Awesome-swift
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,204 | 🐛 8 | 🌐 Ruby | 📅 2026-08-03 - A collaborative list of awesome swift resources.
  * [@Wolg](https://github.com/Wolg/awesome-swift) ⭐ 5,876 | 🐛 111 | 📅 2026-04-12 - A curated list of awesome Swift frameworks, libraries and software.
