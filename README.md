...
# Awesome Deprecated! This list will no longer be updated due to my focus shift. with stars
...
* [MMWormhole](https://github.com/mutualmobile/MMWormhole) ⭐ 3,931 | 🐛 19 | 🌐 Objective-C | 📅 2024-02-02 - A powerful toolkit for synthesizing, processing, and analyzing sounds.

<space><space>\<img src="<https://github.com/mutualmobile/MMWormhole/blob/master/MMWormhole.gif> ⭐ 3,931 | 🐛 19 | 🌐 Objective-C | 📅 2024-02-02" width="500") alt="Example App"/>

### UI

* [IGInterfaceDataTable](https://github.com/Instagram/IGInterfaceDataTable) ⚠️ Archived - A category on WKInterfaceTable that makes configuring tables with multi-dimensional data easier.

<space><space>\<img src="<https://github.com/Instagram/IGInterfaceDataTable/blob/master/images/example.jpg> ⚠️ Archived" width="500") alt="Example App"/>

* [JBWatchActivityIndicator](https://github.com/mikeswanson/JBWatchActivityIndicator) ⭐ 527 | 🐛 3 | 🌐 Objective-C | 📅 2016-05-17 - An easy way to generate activity indicator images for Apple Watch.
...
* [YOChartImageKit](https://github.com/yasuoza/YOChartImageKit) ⭐ 423 | 🐛 9 | 🌐 Objective-C | 📅 2019-12-12 - A chart image framework for watchOS.
...
* [NKWatchChart](https://github.com/NilStack/NKWatchChart) ⭐ 254 | 🐛 9 | 🌐 Objective-C | 📅 2016-02-12 - A chart library for Apple Watch based on PNChart and ios-charts.
...
* [RadialChartImageGenerator](https://github.com/hmaidasani/RadialChartImageGenerator) ⭐ 443 | 🐛 11 | 🌐 JavaScript | 📅 2021-11-01 - A radial bar chart generator for apple watch.
* [KFWatchKitAnimations](https://github.com/kiavashfaisali/KFWatchKitAnimations) ⭐ 348 | 🐛 0 | 🌐 Swift | 📅 2020-11-12 - An image generator that creates beautiful 60 FPS animations for  Watch by recording animations from the iOS Simulator.

# Sample Apps

* [SwiftHN](https://github.com/Dimillian/SwiftHN) ⭐ 1,740 | 🐛 21 | 🌐 Swift | 📅 2020-10-01 - A Hacker News reader written in Swift.

* [WatchKit-Apps](https://github.com/kostiakoval/WatchKit-Apps) ⭐ 1,136 | 🐛 0 | 🌐 Swift | 📅 2017-01-03 - Tutorials app for WatchKit.

* [watchOS-2-Sampler](https://github.com/shu223/watchOS-2-Sampler) ⭐ 1,075 | 🐛 5 | 🌐 Swift | 📅 2021-11-22 - Code examples for new features of watchOS 2.

* [BaiduFM-Swift](https://github.com/belm/BaiduFM-Swift) ⭐ 578 | 🐛 12 | 🌐 Swift | 📅 2026-08-11 - A apple watch app for BaiduFM.
...
* [Cherry](https://github.com/kenshin03/Cherry) ⭐ 390 | 🐛 2 | 🌐 Swift | 📅 2015-06-11 - A mini pomodoro timer app designed for the  Watch.
...
* [WWDC](https://github.com/sugarso/WWDC) ⭐ 383 | 🐛 1 | 🌐 Swift | 📅 2019-06-04 - An open sourcing WWDC hit parties app.

  <space><space>\<img src="<https://raw.githubusercontent.com/sugarso/WWDC/master/Assets/watch1.png>") alt="Example App" width="230"/>

* [done-swift](https://github.com/FancyPixel/done-swift) ⭐ 149 | 🐛 4 | 🌐 Objective-C | 📅 2017-04-18 - A sample app to demonstrate data sharing between a WatchKit app and its main app using Realm.
...
* [WatchPics](https://github.com/D-32/WatchPics) ⭐ 96 | 🐛 4 | 🌐 Objective-C | 📅 2021-01-24 - Instagram for the Apple Watch.
...
* [WatchNotes](https://github.com/azamsharp/WatchNotes) ⭐ 83 | 🐛 2 | 🌐 Swift | 📅 2015-10-29 - An apple watch app to display notes on your wrist.
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,135 | 🐛 0 | 📅 2026-09-15 list of open source ios apps
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,673 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 list.
* [awesome-ios-ui](https://github.com/cjwirth/awesome-ios-ui) ⭐ 11,213 | 🐛 12 | 📅 2018-03-08 - A curated list of awesome iOS UI/UX libraries.
* [awesome-ios-animation](https://github.com/sxyx2008/awesome-ios-animation) ⭐ 5,462 | 🐛 0 | 📅 2025-10-28 - A curated list of awesome iOS animation, including Objective-C and Swift libraries.
...
* [awesome-gists](https://github.com/vsouza/awesome-gists#ios) ⭐ 770 | 🐛 1 | 📅 2025-06-24 - A list of amazing gists (iOS section).
...
* Awesome-swift
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,257 | 🐛 13 | 🌐 Ruby | 📅 2026-09-01 - A collaborative list of awesome swift resources.
  * [@Wolg](https://github.com/Wolg/awesome-swift) ⭐ 5,891 | 🐛 111 | 📅 2026-04-12 - A curated list of awesome Swift frameworks, libraries and software.
